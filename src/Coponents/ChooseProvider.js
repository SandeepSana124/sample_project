...
const ChooseProvider = () => {
  ...
  return (
    <div>
      {/* <nav class="navbar">
        <div class="d-flex container-fluid color w-100">
        <img src={require('/home/sandeepsana/Desktop/Routing/sample_project/src/Assests/choose.png')} alt='UFC Logo' className='' />

          



          <div class="shape justify-content-center">
      ...
      <div className='chooseicon m-10 d-flex justify-content-center'>
